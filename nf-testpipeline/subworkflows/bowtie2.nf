...
include { BOWTIE2_ALIGN as BOWTIE2_ALIGN_CUTADAPT } from '../modules/bowtie2_align'
include { BOWTIE2_ALIGN as BOWTIE2_ALIGN_TRIMMOMATIC } from '../modules/bowtie2_align'
