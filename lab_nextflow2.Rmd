...
We now know how to create and use Channels to send data around a workflow. We will now see how to run tasks within a workflow using [processes](https://docs.seqera.io/nextflow/process).
...
[Directive](https://docs.seqera.io/nextflow/process#directives) declarations allow the definition of optional settings that affect the execution of the current process without affecting the semantic of the task itself.
...
The exercises below are designed to strengthen your knowledge in Nextflow. 
...
2. Given sample sheet contains multiple entries for same sample and a mix of single and paired end reads, create separate channel for single and multiple entries.
