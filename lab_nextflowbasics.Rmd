...
[Nextflow](https://docs.seqera.io/nextflow/) is a domain specific language (DSL) implemented on top of the Groovy programming language, which in turn is a super-set of the Java programming language. This means that Nextflow can run any Groovy or Java code.
...
[Channels](https://docs.seqera.io/nextflow/reference/channel) are a key data structure of Nextflow that allows the implementation of reactive-functional oriented computational workflows based on the Dataflow programming paradigm.
...
[Operators](https://docs.seqera.io/nextflow/reference/operator) are methods that allow you to connect, transform values, or apply some user-provided rules.
