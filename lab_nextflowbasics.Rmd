...
3. Given the /data/samplesheet.csv, read the input files from the samplesheet into a channel which cotains the fastq as well as the metadata associated with it.

4. Separate the above channel based on the sample type.
